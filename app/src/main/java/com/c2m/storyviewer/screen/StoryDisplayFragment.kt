...
class StoryDisplayFragment : Fragment(),
    ...
    override fun onResume() {
        ...
        try {
            ...
            Toast.makeText(requireContext(), "Stories Counter Size:$e", Toast.LENGTH_SHORT).show()
        }
    ...
    private fun initializePlayer() {
        ...
        val mediaSource = ExtractorMediaSource.Factory(mediaDataSourceFactory).createMediaSource(
